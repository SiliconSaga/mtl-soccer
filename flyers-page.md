...
*To update a flyer (for example for a new season): edit the HTML in `flyers/fall-2026/` and open a PR — the exports regenerate automatically and the PR preview shows the result.*
