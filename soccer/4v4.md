...
- Shin guards are **required** — the coach provides them for 1st/2nd Grade; 3rd graders in the girls league should bring their own if they have a pair, and ask the coach if not (extras may be available)
